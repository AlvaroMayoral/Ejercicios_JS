...
function updateBaseprice() {
  return (globalBasePrice = globalBasePrice + 15000)
}
const car1 = { name: 'BMW m&m', basePrice: 50000, finalPrice: 60000 }
const car2 = { name: 'Chevrolet Corbina', basePrice: 70000, finalPrice: 80000 }

function calculatefinalPrice(cars) {
  if (cars.finalPrice >= 25000) {
    return (cars.finalPrice = globalBasePrice + cars.basePrice)
  }
}

updateBaseprice()
calculatefinalPrice(car1)
calculatefinalPrice(car2)
